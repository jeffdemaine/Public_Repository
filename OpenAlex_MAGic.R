...
# Jeff Demaine (ORICD #0000-0003-4586-1317), June 2022

# Fetch the packages:
install.packages("openalexR") # To query OpenAlex
install.packages("RSQLite") # Load R's internal SQLite database.
install.packages("DBI") # Not sure if this is necessary, as it seems to be inside RSQLite anyways...

# Cannot seem to find the "openalexR" package in CRAN, so get it from GitHub:
